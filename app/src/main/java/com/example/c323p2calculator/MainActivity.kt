package com.example.c323p2calculator
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (sin != null) {
            sin.setOnClickListener {
                numView.text = sin(numView.text.toString().toDouble()).toString()
        ...
        if (cos != null) {
            cos.setOnClickListener {
                numView.text = cos(numView.text.toString().toDouble()).toString()
        ...
        if (tan != null) {
            tan.setOnClickListener {
                numView.text = tan(numView.text.toString().toDouble()).toString()
